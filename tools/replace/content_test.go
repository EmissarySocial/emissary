...
// TestContent_Naive verifies that every occurrence of a plain substring is replaced
...
// TestContent_AtBeginning verifies that a match at the very start of the string is replaced
...
// TestContent_AtEnd verifies that a match at the very end of the string is replaced
...
// TestContent_SkipHTML verifies that a match inside an HTML attribute is left alone
...
// TestContent_SkipHTML_AtEnd verifies that the HTML guard still applies when the match is the last token
...
// TestContent_CaseInsensitive verifies that matching ignores case, in either direction
