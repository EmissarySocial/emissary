...
Only the Layout tab paints them, all five at once, one per option. The edit page used to show the checked one between its chevrons and no longer does, so these five files have exactly one consumer.
