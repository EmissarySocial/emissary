...
func (service *MerchantAccount) Refresh(circleService *Circle, connectionService *Connection, jwtService *JWT, identityService *Identity, privilegeService *Privilege, userService *User, masterKey string, host string) {
