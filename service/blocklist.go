...
func (service BlockList) ListObjects(criteria expression.Expression, options ...option.Option) (data.Iterator, error) {
	return service.List(criteria, options...)
}

// LoadObject wraps the `Load` method as a generic Object
func (service BlockList) LoadObject(criteria expression.Expression) (data.Object, error) {
	return service.Load(criteria)
}

// SaveObject wraps the `Save` method as a generic Object
func (service BlockList) SaveObject(object data.Object, note string) error {
...
func (service BlockList) DeleteObject(object data.Object, note string) error {
