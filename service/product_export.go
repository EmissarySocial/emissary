...
// ExportCollection returns the IDs of every Product to include in a User's data export
...
// ExportDocument returns a single Product as a JSON string, for a User's data export
