...
// OriginTypeLike identifies a link that was retrieved because of a "Like" of an existing post
const OriginTypeLike = "LIKE"

// OriginTypeDislike identifies a link that was retrieved because of a "Dislike" of an existing post
