...
func FollowingSchema() schema.Element {
	return schema.Object{
		Properties: schema.ElementMap{
			...
			"notes":         schema.String{Format: "text", MaxLength: 1024},
			...
			"status":        schema.String{Enum: []string{FollowingStatusNew, FollowingStatusLoading, FollowingStatusImportPending, FollowingStatusSuccess, FollowingStatusFailure, FollowingStatusPaused, FollowingStatusGone}},
