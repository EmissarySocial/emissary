	...
	return schema.Object{
		Properties: schema.ElementMap{
			...
			"providerId": schema.String{Enum: []string{
				...
				ConnectionProviderFREEIPAPICOM,
				ConnectionProviderGeoapify,
				ConnectionProviderGiphy,
				ConnectionProviderGoogleMaps,
				ConnectionProviderIPAPICO,
				ConnectionProviderIPAPICOM,
				ConnectionProviderNominatim,
				ConnectionProviderOpenStreetMap,
				ConnectionProviderStaticGeocoderIP,
			...
			"type": schema.String{Enum: []string{
				ConnectionTypeGeocoder,
				ConnectionTypeGeocoderIP,
				ConnectionTypeGeosearch,
				ConnectionTypeImage,
