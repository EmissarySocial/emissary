...
type Subscriber struct {
	...
	FediverseHandle      string             `bson:"fediverseHandle"`      // Fediverse handle of the subscriber -- used to send subscription notifications
	EmailAddress         string             `bson:"emailAddress"`         // Email address of the subscriber
	AuthorizationCode    string             `bson:"authorizationCode"`    // One-time code that authenticates a subscriber's browser session
	RemoteUserID         string             `bson:"remoteUserId"`         // ID generated by the merchant account for the user/purchaser
	RemoteSubscriptionID string             `bson:"remoteSubscriptionId"` // ID generated by the merchant account for the subscription/plan
	RemoteSubscriberID   string             `bson:"remoteSubscriberId"`   // ID generated by the merchant account for the subscriber/purchase
...
func (subscriber *Subscriber) UpdateWith(other *Subscriber) bool {
	...
	if other.FediverseHandle != "" {
		if other.FediverseHandle != subscriber.FediverseHandle {
			subscriber.FediverseHandle = other.FediverseHandle
			changed = true
		}
	}

	if subscriber.RemoteUserID != other.RemoteUserID {
		subscriber.RemoteUserID = other.RemoteUserID
		changed = true
	}

	if subscriber.RemoteSubscriptionID != other.RemoteSubscriptionID {
		subscriber.RemoteSubscriptionID = other.RemoteSubscriptionID
		changed = true
	}

	if subscriber.RemoteSubscriberID != other.RemoteSubscriberID {
		subscriber.RemoteSubscriberID = other.RemoteSubscriberID
		changed = true
	}
