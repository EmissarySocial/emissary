...
type Template struct {
	...
	Actions     map[string]ActionConfig `json:"actions"       bson:"actions"`     // Map of actions that can be performed on streams of this Template
}
...
func (template Template) ActionConfig(actionID string) (ActionConfig, bool) {
