...
func CircleSchema() schema.Element {
	return schema.Object{
		Properties: schema.ElementMap{
			...
			"color":       schema.String{Format: "color", Default: "#000000"},
			"icon":        schema.String{Format: "token", MaxLength: 64, Default: "circle", Required: true},
			"description": schema.String{Format: "text", MaxLength: 2048},
