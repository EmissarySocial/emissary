...
func (step StepStripeSetup) Post(renderer Renderer, _ io.Writer) error {
	...
	if webhookSecret, _ := stripeClient.GetStringOK(providers.Stripe_WebhookSecret); webhookSecret == "" {
