...
// TestReceive_UpdateActor_RejectsMismatchedActor pins the self-update rule: an actor may only
...
func TestReceive_UpdateActor_RejectsMismatchedActor(t *testing.T) {
	...
	require.Error(t, receive_UpdateActor(Context{}, activity))
}
