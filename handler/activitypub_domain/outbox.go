...
// GetOutboxCollection serves the outbox of the domain-wide "@search" actor
...
// GetOutboxMessage serves a single Announce activity from the "@search" actor's outbox
